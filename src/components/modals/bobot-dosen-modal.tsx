...
interface BobotDosenModalProps {
  isOpen: boolean;
  onOpenChange: (open: boolean) => void;
  bobot: BobotDosen | null;
  onSubmit: (data: { nama: string; bobot: number }) => void;
  existingTotal: number;
}

export function BobotDosenModal({
  isOpen,
  onOpenChange,
  bobot,
  onSubmit,
}: BobotDosenModalProps) {
      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            {bobot
              ...
              : "Tambahkan kriteria dan bobot penilaian baru untuk dosen."}
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleSubmit} disabled={isSaving}>
            ...
            {bobot ? "Simpan Perubahan" : "Tambah Kriteria"}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
